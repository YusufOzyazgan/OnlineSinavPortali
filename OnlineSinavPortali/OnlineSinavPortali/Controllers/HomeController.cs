...
namespace OnlineSinavPortali.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> UserPage()
        {
            ...
            //e1cdde44-39c7-4618-a50a-94daff8c7a77 student İd
        ...
        public async Task<IActionResult> StudentRegister(StudentRegisterModel model)
        {
            ...
            string photoUrl = "kullanıcı_yok.png";
        ...
        public async Task<IActionResult> TeacherRegister(TeacherRegisterModel model)
        {
            ...
            var createdAt = DateTime.Now;
            var identityResult = await _userManager.CreateAsync(new() { UserName = model.Username, Email = model.Email, FullName = model.FullName, CreatedAt = createdAt }, model.Password);
        ...
        {
            return RedirectToAction("Concat");
        }
